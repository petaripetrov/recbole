...
class FairRecommender(AbstractRecommender):
    """This is a abstract fair recommender. All the general model should implement this class.
    The base fair recommender class provide the basic dataset and parameters information.
    """
    type = ModelType.GENERAL

    def __init__(self, config, dataset):
        super(FairRecommender, self).__init__()
